...
const UserCourses = () => {
  ...
  const element = (
    <div className="courses-page-outer-div">
      <HeaderCard>
        <p className="user-courses-header-name-text">{verticalInfo.name}</p>
        <p className="user-courses-header-desc-text">{verticalInfo.desc}</p>
      </HeaderCard>
