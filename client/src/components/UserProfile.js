...
const UserProfile = () => {
  ...
  <div class="form-group row profile">
    <label for="staticUserId" class="col-sm-2 col-form-label">UserID</label>
    <div class="col-sm-10">
      <input type="text" readonly class="form-control-plaintext" id="staticUserId" value="UserID"/>
    </div>
  </div>
  <div class="form-group row profile">
  ...
  <div style={{margin: "50px 0 0 44%"}}>
    <button className='btn btn-success update' style={{}}>Update</button>
